...
const key = 'mms_customers_meter_readings';


//-----------------------------------------------------------------------------
//             GET ALL MMS meter reading :  get /customers/meter-reading
//-----------------------------------------------------------------------------

// Handling the process GET meter reading
export const get = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const totalItems = await prismaClient.t_mms_meter_reading.count({
            where: combinedWhereClause,
        });

        // Fetch paginated records
        const data = await prismaClient.t_mms_meter_reading.findMany({
            where: combinedWhereClause,
